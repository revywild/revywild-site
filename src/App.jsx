...
const T = {
  ...
  jp: {
    ...
    home: {
      ...
      sub: "マウイと東京を起点に、ネットワークとホスピタリティの分野で活動しています。長年かけて築いた人脈と土地勘を活かして、あなたにベストな選択をお届けします。",
      cta: "提供内容を見る",
      stats: [
        ["1億6千万円+", "マウイのカフェ＆宿泊施設"],
    ...
    izakaya: {
      ...
      filterP2: "3軒で合計3時間。グループでの体験で、おひとり様約$100です。",
      ...
      stops: [
        ...
        { n: "03", title: "地元流で、夜を締める。", area: "ウェディング会場近く", body: "最後は披露宴帰りの人たちでにぎわう、エネルギッシュな一軒。そこでしか作り出せない空気感がある、締めくくりにぴったりの場所です。" },
      ],
    ...
    about: {
      ...
      h1: "Revy Wild", h1sub: "紹介先は、圧倒的な価値がある",
      paras: [
        "Google、Meta、そして複数のスタートアップで働いた後、マウイ島でカフェと宿泊施設の運営に転身しました。1年以内に廃棄率を15%から3%に削減し、売上を20%改善。現在は遠隔で管理しながら、カフェと宿泊施設で合計$1M以上の売上を達成しています。日本語能力試験N2を取得し、47都道府県すべてを地方の家に泊まりながら旅しました（計67軒）。東京への移住前の5年間は、年2回のペースで通い続け、移住してから現在で約4年半が経ちます。",
        "この期間に、Googleのディレクターや数百億円規模の企業の経営者、地元の日本人の方々を東京各地にご案内してきました。100名以上の転職希望者に、非テクノロジーからFAANG企業への就職をサポートしてきました。3名の方にマウイでの宿泊事業の立ち上げも、お手伝いをしています。",
        "シェフとのセッションも、居酒屋リストも、5年以上かけて日本語で同じ場所・日本語で価値ある人たちと向き合い続けてきました。",
      ],
      cta: "お問い合わせ",
    },
    contact: {
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "flex-end", padding: "0 48px 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div className="hero-copy" style={{ position: "relative", zIndex: 2, maxWidth: 680 }}>
          <div style={{ opacity: heroLoaded ? 1 : 0, transform: heroLoaded ? "translateY(0)" : "translateY(30px)", transition: "opacity 1.4s cubic-bezier(0.19,1,0.22,1) 0.3s, transform 1.4s cubic-bezier(0.19,1,0.22,1) 0.3s" }}>
            ...
            <h1 className="serif" style={{ fontSize: lang === "jp" ? "clamp(32px, 6vw, 72px)" : "clamp(48px, 8vw, 100px)", fontWeight: 300, lineHeight: lang === "jp" ? 1.2 : 0.95, marginBottom: 40 }}>              {t.h1a}<br />{t.h1b}<br />
